            ...
            await this.serviceProvider
                ...
                .Send(
                    new GrantProfileAccessCommand(
                        ...
                        request.IsPhoneNotificationEnabled,
                        request.IsPhoneNotificationOnDeliveryEnabled,
                        request.Details,
                ...
                await this.serviceProvider
                    ...
                    .Send(
                        new CreateOrUpdateIndividualCommand(
                            ...
                            request.IsEmailNotificationEnabled,
                            request.IsPhoneNotificationEnabled,
                            request.LicenceAgreement,
                            request.GdprAgreement,
                            request.ActionLoginId,
                            request.Ip),
                        context.CancellationToken);
                ...
                await this.serviceProvider
                    ...
                    .Send(
                        new CreateRegisterRequestCommand(
                            ...
                            request.RegistrationIsPhoneNotificationEnabled,
                            request.Name,
                            request.Identifier,
                            request.Phone,
                            request.Email,

...
using static ED.Domain.IAdminProfileCreateEditViewQueryRepository;

namespace ED.Domain
{
    partial class AdminProfileCreateEditViewQueryRepository : IAdminProfileCreateEditViewQueryRepository
    {
        public async Task<GetAdminProfileVO> GetAdminProfileAsync(
            int id,
            CancellationToken ct)
        {
            GetAdminProfileVO vo = await (

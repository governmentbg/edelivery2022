...
namespace SAML2.Config.ConfigurationManager
{
    ...
    public class IdentityProviderElement : WritableConfigurationElement, IConfigurationElementCollectionElement
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to omit metadata signature check.
        /// </summary>
        /// <value><c>true</c> if metadata signature check should be omitted; otherwise, <c>false</c>.</value>
        [ConfigurationProperty("omitMetadataSignatureCheck")]
        public bool OmitMetadataSignatureCheck
        {
            get { return (bool)base["omitMetadataSignatureCheck"]; }
            set { base["omitMetadataSignatureCheck"] = value; }
        }

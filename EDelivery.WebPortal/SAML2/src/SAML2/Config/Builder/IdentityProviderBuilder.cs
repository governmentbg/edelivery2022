...
namespace SAML2.Config.Builder
{
    ...
    public class IdentityProviderBuilder
    {
        ...
        /// <summary>
        /// Omit metadata signature checks.
        /// </summary>
        private bool _omitMetadataSignatureCheck;
        ...
        public IdentityProvider Build()
        {
            ...
            config.OmitMetadataSignatureCheck = _omitMetadataSignatureCheck;
        ...
        /// <summary>
        /// Enables omitting metadata signature checks..
        /// </summary>
        /// <param name="value"><c>true</c> or <c>false</c>.</param>
        /// <returns>The <see cref="IdentityProviderBuilder"/>.</returns>
        public IdentityProviderBuilder OmitMetadataSignatureCheck(bool value = true)
        {
            _omitMetadataSignatureCheck = value;
            return this;
        }

...
{
    public class SearchMessageRecipientIndividualsRequirement : IAuthorizationRequirement
    {
    }
    ...
    public class SearchMessageRecipientIndividualsRequirementHandler
        : AuthorizationHandler<SearchMessageRecipientIndividualsRequirement>
    {
        protected override Task HandleRequirementAsync(
            AuthorizationHandlerContext context,
            SearchMessageRecipientIndividualsRequirement requirement)
        {
        ...
        private bool HasAccessTargetGroupSearch(int profileId)
        {
            ...
            var resp = authorizationClient.HasAccessTargetGroupSearch(
                ...
                {
                    ProfileId = profileId,
                    TargetGroupId = (int)TargetGroupId.Individual
                });

...
namespace ED.IntegrationService
{
    public partial class DataContractMapper
    {
        public static DcDocument ToDcDocument(
            ED.DomainServices.IntegrationService.GetSentDocumentContentResponse resp)
        {
            if (resp.Blob == null)
            {
                return null;
        ...
        public static List<DcSignatureValidationResult> ToListOfDcSignatureValidationResult(
            ED.DomainServices.IntegrationService.GetSentDocumentContentResponse.Types.Signature[] signatures)
        {
            bool containsTimeStamp = false;
            string timeStampAuthority = null;
            DateTime? timeStampDate = null;
            ED.DomainServices.IntegrationService.GetSentDocumentContentResponse.Types.Signature tsSig =

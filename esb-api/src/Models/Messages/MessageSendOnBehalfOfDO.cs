...
public class MessageSendOnBehalfOfDOValidator : AbstractValidator<MessageSendOnBehalfOfDO>
{
    private readonly HttpContext httpContext;
    private readonly EsbClient esbClient;
    private readonly ITemplateService templateService;

    public MessageSendOnBehalfOfDOValidator(
        ...
        ITemplateService templateService)
    {
        ...
        {
            throw new Exception($"'{nameof(MessageSendOnBehalfOfDOValidator)}' called outside of a request. IHttpContextAccessor.HttpContext is null!");
        }
